    ...
    switch (gradientType) {
      ...
      case GradientType.radial:
        return RadialGradient(
          center: Alignment(
              gradientData[0].gradientPos.$1 * 2.0 - 1.0, gradientData[0].gradientPos.$2 * 2.0 - 1.0),
          colors: [Color(gradientData[0].color), Color(gradientData[1].color)],
          stops: [
            0.5,
            1.0,
      ...
      case GradientType.sweep:
        return SweepGradient(
          ...
          stops: [0.0, 0.5, 1.0],
          transform: GradientRotation(-atan2(gradientData[1].gradientPos.$1 - 0.5, gradientData[1].gradientPos.$2 - 0.5) - pi / 2.0),
        );
    }
  }
