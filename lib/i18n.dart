      ...
      const {
        "en_us": {
          ...
          'visible_condition_tooltip':
              'Visible condition (visible when true)',
          ...
          'recently_tooltip': 'Drag and drop to make a copy or restore a recently deleted choice',
          ...
          'source': 'Sources',
          'source_hint':
              'If you dont know a source, leave it blank.',
          'crop': 'Crop',
          'code_hint_execute_condition': 'Execution Conditions',
          'code_hint_visible_condition': 'Visible Conditions (Visible when true)',
