...
extension Localization on String {
  static final _t = Translations.byLocale("en-US") +
      ...
      const {
        ...
        "en": {
          ...
          'backup_frequency': 'Backup frequency(min, only folder support)',
          'settings': 'Settings',
        ...
        "ko": {
          ...
          'backup_frequency': '백업 주기(분, 폴더만 지원)',
          'settings': '설정',
          'project_name': '프로젝트명',
          'create': '생성',
      ...
      const {
        ...
        "en": {
          ...
          'elevation': 'Elevation for shadow',
          'round': 'Rounded corners',
          'padding': 'Inner padding',
          'image_maxHeight_ratio': 'Maximum height of the image as a proportion of screen height',
          'image_maxHeight_ratio_tooltip': '1.0 equals full screen height, 0.5 is half the screen height.',
        ...
        "ko": {
          ...
          'round': '라운드',
          'padding': '내부 여백',
          'image_maxHeight_ratio': '이미지 최대 높이(화면 높이 대비)',
          'image_maxHeight_ratio_tooltip': '1.0은 전체 화면 높이, 0.5는 화면 높이의 반',
          'hide_title': '제목 숨기기',
          'title_up': '제목을 위로',
      ...
      const {
        "en": {
          ...
          'margin_vertical_sub': 'Default value %.1f',
  ...
  String i18nF(List<Object> params) {
    return localizeFill(i18n, params);
  }
