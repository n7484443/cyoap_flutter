  ...
  static final _t = Translations.byLocale("en-US") +
      ...
      const {
        "en": {
          ...
          'from_simple_to_code_button': 'Change to code editor\n(this action on this node cannot be undone)',
          'from_code_to_simple_button': 'Change to simple editor\n(clean every code)',
        ...
        "ko": {
          ...
          'from_simple_to_code_button': '코드 에디터로 변경\n(해당 노드의 에디터는 되돌릴 수 없음)',
          'from_code_to_simple_button': '심플 에디터로 변경\n(모든 코드는 지워짐)',
