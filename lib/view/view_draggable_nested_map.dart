...
class NodeDividerDialog extends ConsumerStatefulWidget {
  ...
  const NodeDividerDialog(this.y, {
    super.key,
  });
...
class _NodeDividerDialogState extends ConsumerState<NodeDividerDialog> {
  ...
  void initState() {
    ...
    _nameController = TextEditingController(
        text: ref
            .read(lineOptionProvider(widget.y))
            .name ??
      ...
      content: Column(
        ...
        children: [
          ...
          DropdownButtonFormField<String>(
            ...
            value: ref
                .watch(lineOptionProvider(widget.y))
                .presetName,
          ),
          TextField(
    ...
    if (isEditable) {
      if (lineLength == 0) {
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: IconButton(
                onPressed: () {
                  ref.read(vmDraggableNestedMapProvider).addData(
                      const Pos(data: [0, 0]), ChoiceNode.empty()
                    ..width = 3);
                },
        ...
        sliverList = List.generate(lineList.length * 2, (index) {
          ...
          if (ref
              .watch(childrenChangeProvider(pos))
              .isEmpty) {
            return SliverToBoxAdapter(
              child: Row(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: IconButton(
                      onPressed: () {
                        ref.read(vmDraggableNestedMapProvider).addData(
                            pos.addLast(0), ChoiceNode.empty()
                          ..width = 3);
                      },
                      icon: const Icon(Icons.add),
                      tooltip: 'create_tooltip'.i18n,
            ...
            children: [
              SizedBox(
                ...
                child: TextButton(
                  onPressed: () {
                    if (ref
                        .watch(selectedChoiceNodeProvider)
                        .isNotEmpty) {
                      showDialog(
                        context: context,
