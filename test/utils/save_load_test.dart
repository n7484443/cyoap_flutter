...
EditablePlatform createPlatform() {
  ...
  platform.addData(const Pos(data: [0, 0, 0]), ChoiceNode(title: "save load test 1", width: 12, contents: "testData 1"));
  platform.addData(const Pos(data: [0, 1, 0]), ChoiceNode(title: "save load test 2", width: 12, contents: "testData 2")..conditionalCodeHandler.conditionVisibleString = "\$[save load test 1]");
